...
export async function seedOpportunitiesDealsAndViews(ctx: SeedContext) {
  ...
  const interactions: {
    ...
    { type: "EMAIL", daysAgo: 74, summary: "Priya Raman confirmed ISP's Spain expansion mandate is live and asked to be shown bilingual schools in secondary cities.", participants: ["Fouad Mallat", "Priya Raman"], organisation: "International Schools Partnership", nextStep: "Run a reverse match against the ISP mandate", sentiment: "POSITIVE", logger: ctx.fouad },
    ...
    { type: "EMAIL", daysAgo: 91, summary: "James Whitfield confirmed Inspired's threshold is above where Cervantes is positioned. Polite pass.", participants: ["Fouad Mallat", "James Whitfield"], deal: "Project Cervantes", sentiment: "CAUTIOUS", logger: ctx.fouad },
    { type: "CALL", daysAgo: 31, summary: "Marina Solís on debt appetite for Spanish education. Banks will lend 3.0–3.5× EBITDA against owned property, materially less against leasehold.", participants: ["Fouad Mallat", "Marina Solís"], organisation: "Banco Ibérico Corporate", sentiment: "NEUTRAL", logger: ctx.fouad },
    ...
    { type: "CALL", daysAgo: 88, summary: "Bruno Ferrán at Serra Patrimonio on the Monteverde campus. He confirmed the freehold sits in the family holding company, separate from the school entity.", participants: ["Fouad Mallat", "Bruno Ferrán"], institution: "Colegio Monteverde", sentiment: "NEUTRAL", logger: ctx.fouad },
    { type: "CONFERENCE", daysAgo: 120, summary: "Milan education summit. Brief conversation with Matteo Bellini at Alpina about southern European vocational assets.", participants: ["Fouad Mallat", "Matteo Bellini"], organisation: "Alpina Capital", sentiment: "NEUTRAL", logger: ctx.fouad },
    { type: "CALL", daysAgo: 21, summary: "Carlos Mendoza confirmed Cognita's Spain team has capacity for two more processes this year.", participants: ["Fouad Mallat", "Carlos Mendoza"], organisation: "Cognita", sentiment: "POSITIVE", logger: ctx.fouad },
    ...
    { type: "MEETING", daysAgo: 28, summary: "Montserrat Casals at Casa Ventura. Patient capital, no fund clock, explicitly will not force an exit. The right partner for a founder who does not want to sell control.", participants: ["Fouad Mallat", "Montserrat Casals"], organisation: "Casa Ventura Family Office", sentiment: "POSITIVE", logger: ctx.fouad },
    ...
    { type: "MEETING", daysAgo: 40, summary: "Ricardo Peña on family-business governance. He sees succession disputes early and is willing to flag situations where a third party would help.", participants: ["Fouad Mallat", "Ricardo Peña"], organisation: "Garrigues Peña Abogados", sentiment: "POSITIVE", logger: ctx.fouad },
    { type: "EMAIL", daysAgo: 150, summary: "Omar Al Fahim asked to be kept informed of European brand opportunities above €30m.", participants: ["Fouad Mallat", "Omar Al Fahim"], organisation: "Gulf Education Holdings", sentiment: "NEUTRAL", logger: ctx.fouad },
    ...
    { type: "CALL", daysAgo: 210, summary: "Introductory call with Omar Al Fahim's team. Exploratory only.", participants: ["Fouad Mallat", "Omar Al Fahim"], organisation: "Gulf Education Holdings", sentiment: "NEUTRAL", logger: ctx.fouad },
    { type: "NOTE", daysAgo: 1, summary: "Weekly origination review: Monteverde moved to Qualified. Access route through Elena Vidal confirmed as the primary path.", participants: ["Fouad Mallat", "Sofia Lange"], institution: "Colegio Monteverde", sentiment: "POSITIVE", logger: ctx.fouad },
    ...
    { type: "MEETING", daysAgo: 60, summary: "Ursula Steinmann in Zug. Helvetia is a long-hold buyer for premium alpine and DACH assets only. Not relevant to Iberia.", participants: ["Fouad Mallat", "Ursula Steinmann"], organisation: "Helvetia Bildung Holding", sentiment: "NEUTRAL", logger: ctx.fouad },
    { type: "CALL", daysAgo: 19, summary: "Andrés Cuéllar flagged that a Toledo client has asked about valuation. Did not name them. Terra hypothesis: Colegio Cervantes Toledo.", participants: ["Fouad Mallat", "Andrés Cuéllar"], sentiment: "POSITIVE", nextStep: "Do not push. Let him raise it again.", logger: ctx.fouad },
    ...
    { type: "MEETING", daysAgo: 45, summary: "Lunch with Lars Jensen at Öresund. Their real-assets allocation is paused pending the 2026 strategic review. Not a live counterparty this year.", participants: ["Fouad Mallat", "Lars Jensen"], organisation: "Öresund Pension", sentiment: "CAUTIOUS", logger: ctx.fouad },
